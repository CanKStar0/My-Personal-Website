      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <ScrollReveal delay={0.1} className="md:col-span-1 lg:col-span-1 group">
            <div className="h-full p-8 rounded-3xl border border-zinc-200/60 dark:border-zinc-800/50 bg-zinc-50 dark:bg-zinc-900/40 hover:border-brand-red/30 dark:hover:border-red-900/60 hover:bg-red-50/30 dark:hover:bg-red-950/10 hover:shadow-[0_0_20px_rgba(220,38,38,0.05)] hover:-translate-y-1 transition-all duration-500 flex flex-col">
              ...
              <div className="flex flex-col gap-3 flex-1 justify-center">
                {["TypeScript", "React", "Next.js", "Tailwind CSS", "Framer Motion"].map((tech) => (
                  <div key={tech} className="flex items-center gap-3">
                    ...
                    <span className="text-zinc-600 dark:text-zinc-300 font-medium font-sans text-sm tracking-wide">
                      {tech}
                    </span>
                  </div>
                ))}
            ...
            <div className="h-full p-8 md:p-10 rounded-3xl border border-zinc-200/60 dark:border-zinc-800/50 bg-zinc-50 dark:bg-zinc-900/40 hover:border-brand-red/30 dark:hover:border-red-900/60 hover:bg-red-50/30 dark:hover:bg-red-950/10 hover:shadow-[0_0_20px_rgba(220,38,38,0.05)] hover:-translate-y-1 transition-all duration-500">
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
                ...
                <div className="flex gap-4 opacity-70 group-hover:opacity-100 transition-opacity">
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-200/60 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">PostgreSQL</div>
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-200/60 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">MongoDB</div>
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-200/60 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">MySQL</div>
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-200/60 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">Supabase</div>
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-200/60 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">ElasticSearch</div>
                </div>
              </div>
            </div>
          </ScrollReveal>
