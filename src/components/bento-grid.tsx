      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <ScrollReveal delay={0} className="md:col-span-2 lg:col-span-2 group">
            <div className="relative h-full p-8 md:p-10 rounded-3xl border border-zinc-800/50 bg-zinc-900/40 hover:border-brand-red/50 hover:-translate-y-1 transition-all duration-300 overflow-hidden">
              <div 
          ...
          <ScrollReveal delay={0.1} className="md:col-span-1 lg:col-span-1 group">
            <div className="h-full p-8 rounded-3xl border border-zinc-800/50 bg-zinc-900/40 hover:border-brand-red/50 hover:-translate-y-1 transition-all duration-300 flex flex-col">
              ...
              <div className="flex flex-col gap-3 flex-1 justify-center">
                {["TypeScript", "Next.js", "Tailwind CSS", "Framer Motion"].map((tech) => (
                  <div key={tech} className="flex items-center gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-brand-red/70 group-hover:scale-125 transition-transform" />
          ...
          <ScrollReveal delay={0.3} className="md:col-span-3 lg:col-span-4 group">
            <div className="h-full p-8 md:p-10 rounded-3xl border border-zinc-800/50 bg-zinc-900/40 hover:border-brand-red/50 hover:-translate-y-1 transition-all duration-300">
