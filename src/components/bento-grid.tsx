            ...
            <div className="h-full p-8 md:p-10 rounded-3xl border border-zinc-300/80 dark:border-zinc-800/50 bg-zinc-50 dark:bg-zinc-900/40 hover:border-brand-red/30 dark:hover:border-red-900/60 hover:bg-red-50/30 dark:hover:bg-red-950/10 hover:shadow-[0_0_20px_rgba(220,38,38,0.05)] hover:-translate-y-1 transition-all duration-500">
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
                ...
                <div className="flex gap-4 opacity-70 group-hover:opacity-100 transition-opacity">
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-300/80 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">PostgreSQL</div>
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-300/80 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">MongoDB</div>
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-300/80 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">MySQL</div>
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-300/80 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">Supabase</div>
                  <div className="px-6 py-3 rounded-2xl bg-zinc-100 dark:bg-zinc-950/50 border border-zinc-300/80 dark:border-zinc-800/50 font-mono text-xs text-zinc-600 dark:text-zinc-400">ElasticSearch</div>
                </div>
              </div>
            </div>
          </ScrollReveal>
